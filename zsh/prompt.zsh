...
GIT_PROMPT_MERGING="${PR_BOLD}${PR_MAGENTA}⚡︎${PR_RESET}"
GIT_PROMPT_UNTRACKED="${PR_BOLD}${PR_RED}u${PR_RESET}"
GIT_PROMPT_MODIFIED="${PR_BOLD}${PR_YELLOW}d${PR_RESET}"
GIT_PROMPT_STAGED="${PR_BOLD}${PR_GREEN}s${PR_RESET}"
